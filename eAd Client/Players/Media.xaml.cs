...
public partial class Media : IDisposable
{
    ...
    protected FormBorderStyle FormBorderStyle
    {
        get;
        set;
    }
    ...
    protected AutoScaleMode AutoScaleMode
    {
        get;
        set;
    }
    protected Size AutoScaleDimensions
    {
        get;
        set;
    }
    ...
    {
        // Start the timer for this CurrentMedia
        StartTimer();
    ...
    /// <summary>
    /// Gets or Sets the duration of this CurrentMedia. Will be 0 if ""
    /// </summary>
    public int Duration
    {
        get
    ...
    public void AnimateAway(Canvas Parent)
    {
        ...
        if (CheckAccess())
        {
            ...
            ani.Completed += delegate
            {
                ...
                App.DoEvents();
                this.Dispatcher.BeginInvoke(DispatcherPriority.Normal, new Action<Canvas>((parent) =>
                {
