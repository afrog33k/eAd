...
<html xmlns=""http://www.w3.org/1999/xhtml""  xmlns:v=""urn:schemas-microsoft-com:vml"">
  <head>
    ...
    <script src="" http://maps.google.com.au/?file=api&amp;v=3.x&amp;key=ABQIAAAAzr2EBOXUKnm_jVnk0OJI7xSosDVG8KKPE1-m51RBrvYughuyMxQ-i1QfUnH94QxWIa6N4U6MouMmBA""
...
";
        ...
        protected static string AllLocationsText
        {
            ...
            var marker = new GMarker(latlng"+(location.Available?", markerOptions":"")+@");
            map.addOverlay(marker);" + (location.StationID==Constants.MyStationID?
