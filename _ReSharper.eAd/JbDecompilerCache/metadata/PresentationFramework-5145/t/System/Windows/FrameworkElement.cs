...
namespace System.Windows
{
    ...
    {
        [CommonDependencyProperty] public static readonly DependencyProperty StyleProperty;
        ...
        [CommonDependencyProperty] public static readonly DependencyProperty NameProperty;
        ...
        [CommonDependencyProperty] public static readonly DependencyProperty WidthProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty MinWidthProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty MaxWidthProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty HeightProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty MinHeightProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty MaxHeightProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty FlowDirectionProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty MarginProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty HorizontalAlignmentProperty;
        [CommonDependencyProperty] public static readonly DependencyProperty VerticalAlignmentProperty;
        ...
        ResourceDictionary IHaveResources.Resources { [TargetedPatchingOptOut("Performance critical to inline this type of method across NGen image boundaries")]
