...
namespace Client
{
        ...
        : Media
    {
        ...
        private void PrepareRSS()
        {
            ...
            _rssFilePath = Settings.Default.LibraryPath + @"\" + _mediaid + ".xml";
...
{ 
    ...
    timer = setInterval('tr.TimerTick()', " + _scrollSpeed.ToString() + @");
        ...
        private void LoadRssIntoTempFile()
        {
            try
            {
                string localFeedUrl = Settings.Default.LibraryPath + @"\" + _mediaid + ".xml";
            ...
            catch (Exception ex)
            {
                ...
                File.Delete(Settings.Default.LibraryPath + @"\" + _mediaid + ".xml");
            }
        }
