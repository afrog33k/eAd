...
namespace Client
{
    ...
    class TemporaryHtml : IDisposable
    {
      ...
      //      Assembly assembly = System.Reflection.Assembly.GetExecutingAssembly();
            ...
            using (var stream = new FileStream("Resources/HtmlTemplate.htm",FileMode.OpenOrCreate))//Stream resourceStream = assembly.GetManifestResourceStream("Client.Resources.HtmlTemplate.htm"))
            {
                using (TextReader tw = new StreamReader(stream))
                {
